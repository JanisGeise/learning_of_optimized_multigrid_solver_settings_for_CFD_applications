...
template<class Type>
void Foam::functionObjects::agentSolverSettings::writeFileHeader
(
    Ostream& os,
...
template<class Type>
void Foam::functionObjects::agentSolverSettings::initialiseResidualField
(
    const word& fieldName
)
{
...
template<class Type>
void Foam::functionObjects::agentSolverSettings::updateagentSolverSettings(const word& fieldName)
{
    typedef GeometricField<Type, fvPatchField, volMesh> volFieldType;
